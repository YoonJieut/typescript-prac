 ...
 */
// 클로저를 사용하는 예제
var memberWithClosure = MemberDataWithClosure("user", "pass1", "address1", [
  "item1",
  "item2",
]);
console.log(memberWithClosure()); // 클로저를 통한 데이터 접근
memberWithClosure = MemberDataWithClosure("user4", "pass4", "address6", [
  "item1",
  "item2",
  "item6",
  "item7",
]);
console.log("변화한 것 :", memberWithClosure()); // 클로저를 통한 데이터 접근
